        ...
        <div class="services-wrapper">
            <div class="single-services mb-40">
                <div class="services-img">
                    <img style="width: 90px;" src="{{ asset('themes/shocap/assets/img/delivery-man.png') }}" alt="">
                </div>
                <div class="services-content">
                    <h4>Free Ongkir</h4>
                    <p>Demi kepuasaan customer, kami membuat program free pick up dan free ongkir. </p>
                </div>
            </div>
            <div class="single-services mb-40">
                <div class="services-img">
